    ...
    return (
        <header className="header ">
            ...
            >
                ...
                <div className="bg-transparent  px-4 backdrop-blur-md  h-[3.25rem] overflow-hidden  flex items-center justify-between lg:justify-around border-1 border-[#FF00A6] rounded-3xl ">
