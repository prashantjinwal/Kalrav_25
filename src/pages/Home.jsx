    ...
    <div className="home-page-container mt-[8rem]">
      ...
      <div className="w-full sm:w-9/12 md:w-[65%] lg:w-1/2 mx-auto">
          ...
          {cardContents.map((card, index) => (
            <div key={index}>
              ...
              <div className="px-4 pt-6 flex justify-center">
                <img src="/images/divider.png" alt="Divider" loading="lazy" />
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="px-5 pb-10">
          <h1 className="heading text-[2.5rem] sm:text-[2.9rem] font-medium font-protest text-center text-black p-2 rounded-lg">
            FAQ
          </h1>
