...
export default function Home() {
  ...
  const cardContents = [
    ...
    
    {
      title: "ABOUT",
      content:
        "Kalrav Reincarnated\n\nWith the return of the legendary Kalrav, the atmosphere crackles with excitement, like a katana striking steel! This year’s festival embodies a spirit of togetherness and artistic excellence, much like the harmonious union of Yin and Yang. With over 20,000 students from 100+ colleges across the state eagerly awaiting its revival, Kalrav is set to be grander than ever.\n\nThis year, Kalrav blossoms like a vibrant Japanese matsuri, where the distant roar of taiko drums reverberates through the air, the aroma of sizzling yakitori drifts through the streets, and a kaleidoscope of colors paints the festival grounds. From foot-tapping global hits to soul-stirring vocals, the musical lineup promises to be larger than ever, echoing the energy of past headliners like Honey Singh, Jubin Nautiyal, Guru Randhawa, and Akhil Sachdeva.\n\nBut Kalrav is more than just a festival; it is a cultural bridge, a gateway to boundless creativity and friendship. As artists, musicians, and performers take the stage, the campus will bloom with talent, much like a field of sakura welcoming the arrival of spring.\n\nAs the lanterns glow softly against the night sky and laughter fills the air, Kalrav 2025 becomes more than just an event—it transforms into an experience, a realm where traditions meet innovation, and strangers become lifelong friends. With every beat of the taiko drum and every brushstroke of creativity, we etch memories that will linger far beyond the festival grounds.\n\nThis is not just a celebration; it is a passage into a new world—one where passion fuels dreams, where artistry knows no bounds, and where every soul finds its rhythm. So step into this dimension of wonder, where Kalrav Reincarnated is not just a festival, but a journey into the extraordinary!",
